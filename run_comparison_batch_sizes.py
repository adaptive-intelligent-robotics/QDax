...
def process_args():
    ...
    parser.add_argument(
        "--exp-name", type=str, default="qdax_training"
    )  # exp name to name all results folders
    parser.add_argument(
        "-d", "--directory", type=str, default=os.curdir
    )  # a directory to store all results
    ...
    parser.add_argument(
        "--batch_size_list", nargs="+", type=int, default=[256, 1024, 4096, 8192, 16384]
    )
