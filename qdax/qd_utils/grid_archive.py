...
class Repertoire:
    ...
    def add_to_archive(repertoire, pop_p, bds, eval_scores,dead):
        ...
        keep_eval_scores_filtered = jnp.where(maximum_fitness.at[bd_indexes].get()==eval_scores,True,False)
        ...
        current_fitness_nan = jnp.logical_and(jnp.isnan(current_fitness),keep_eval_scores_filtered)
