...
class NoveltyArchive(flax.struct.PyTreeNode):
    ...
    @partial(jax.jit, static_argnames=("nearest_neighbors",))
    def novelty(
        self,
        ...
        Args:
            ...
            nearest_neighbors: k used to compute the k-nearest-neighbours
        Returns:
        ...
        _, indices = jax.lax.top_k(-distances, nearest_neighbors)
