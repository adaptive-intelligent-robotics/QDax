...
class MultiEmitter(Emitter):
    ...
    def state_update(
        ...
        if multi_emitter_state is None:
            return None

        list_emitter_states = []

        for emitter, emitter_state in zip(
            self.emitters_tuple, multi_emitter_state.emitters_state_tuple
        ):
            emitter_state = emitter.state_update(
                multi_emitter_state,
                repertoire,
                genotypes,
                fitnesses,
